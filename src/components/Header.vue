  ...
  <header class="flex justify-between items-center p-12">
    <div class="flex justify-between">
      <div class="flex items-center">
        <img src="@/assets/img/logo.png" alt="logo" class="w-10 h-10 mr-4" />

        <div>
          <h1 class="font-bold text-xl m-0 uppercase">
            Vue Sneakers
          </h1>
    ...
    <ul class="flex">
      <li class="flex mr-8 items-center">
        <svg
          @click="handlerDrawer"
        ...
        <span class="ml-3 text-sm font-semibold text-gray-500">1205 руб.</span>
      </li>
      <li>
        <svg
